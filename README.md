...
Output examples are shown below and are included in the `output_images/` folder.</br>
...
![fib output](output_images/fib_output.png)</br>

Below is the graph plotting the `n` Fibonacci number calculation over time in seconds. `fib_plot.png` can also be found in the repository. </br>

![fib_plot](fib_plot.png)</br>
